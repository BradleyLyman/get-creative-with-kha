...
var App = function() {
	var layout = new kha_graphics4_VertexStructure();
	layout.add("pos",1);
	this.pipeline = new kha_graphics4_PipelineState();
	this.pipeline.inputLayout = [layout];
	this.pipeline.vertexShader = kha_Shaders.pass_vert;
	this.pipeline.fragmentShader = kha_Shaders.pass_frag;
	this.pipeline.compile();
	this.vertexBuffer = new kha_graphics4_VertexBuffer(3,layout,0);
	var v = this.vertexBuffer.lock();
	v[0] = -0.5;
	v[1] = -0.5;
	v[2] = 0.5;
	v[3] = -0.5;
	...
	this.indexBuffer = new kha_graphics4_IndexBuffer(3,0);
	var i = this.indexBuffer.lock();
	i[0] = 0;
	i[1] = 1;
	i[2] = 2;
...
App.prototype = {
	...
	,render: function(framebuffers) {
		var graphics = framebuffers[0].get_g4();
		graphics.begin();
...
kha_Shaders.init = function() {
	...
	var blobs8 = [];
	var data24 = Reflect.field(kha_Shaders,"pass_fragData" + 0);
	var bytes24 = haxe_Unserializer.run(data24);
	blobs8.push(kha_internal_BytesBlob.fromBytes(bytes24));
	var data25 = Reflect.field(kha_Shaders,"pass_fragData" + 1);
	var bytes25 = haxe_Unserializer.run(data25);
	blobs8.push(kha_internal_BytesBlob.fromBytes(bytes25));
	var data26 = Reflect.field(kha_Shaders,"pass_fragData" + 2);
	var bytes26 = haxe_Unserializer.run(data26);
	blobs8.push(kha_internal_BytesBlob.fromBytes(bytes26));
	kha_Shaders.pass_frag = new kha_graphics4_FragmentShader(blobs8,["pass.frag.essl","pass-webgl2.frag.essl","pass-relaxed.frag.essl"]);
	var blobs9 = [];
	var data27 = Reflect.field(kha_Shaders,"pass_vertData" + 0);
	var bytes27 = haxe_Unserializer.run(data27);
	blobs9.push(kha_internal_BytesBlob.fromBytes(bytes27));
	var data28 = Reflect.field(kha_Shaders,"pass_vertData" + 1);
	var bytes28 = haxe_Unserializer.run(data28);
	blobs9.push(kha_internal_BytesBlob.fromBytes(bytes28));
	var data29 = Reflect.field(kha_Shaders,"pass_vertData" + 2);
	var bytes29 = haxe_Unserializer.run(data29);
	blobs9.push(kha_internal_BytesBlob.fromBytes(bytes29));
	kha_Shaders.pass_vert = new kha_graphics4_VertexShader(blobs9,["pass.vert.essl","pass-webgl2.vert.essl","pass-relaxed.vert.essl"]);
};
...
kha_Shaders.pass_fragData0 = "s146:I3ZlcnNpb24gMTAwCnByZWNpc2lvbiBtZWRpdW1wIGZsb2F0OwpwcmVjaXNpb24gaGlnaHAgaW50OwoKdm9pZCBtYWluKCkKewogICAgZ2xfRnJhZ0RhdGFbMF0gPSB2ZWM0KDEuMCk7Cn0KCg";
kha_Shaders.pass_fragData1 = "s179:I3ZlcnNpb24gMzAwIGVzCnByZWNpc2lvbiBtZWRpdW1wIGZsb2F0OwpwcmVjaXNpb24gaGlnaHAgaW50OwoKb3V0IGhpZ2hwIHZlYzQgZnJhZ0NvbG9yOwoKdm9pZCBtYWluKCkKewogICAgZnJhZ0NvbG9yID0gdmVjNCgxLjApOwp9Cgo";
kha_Shaders.pass_fragData2 = "s148:I3ZlcnNpb24gMTAwCnByZWNpc2lvbiBtZWRpdW1wIGZsb2F0OwpwcmVjaXNpb24gbWVkaXVtcCBpbnQ7Cgp2b2lkIG1haW4oKQp7CiAgICBnbF9GcmFnRGF0YVswXSA9IHZlYzQoMS4wKTsKfQoK";
kha_Shaders.pass_vertData0 = "s134:I3ZlcnNpb24gMTAwCgphdHRyaWJ1dGUgdmVjMiBwb3M7Cgp2b2lkIG1haW4oKQp7CiAgICBnbF9Qb3NpdGlvbiA9IHZlYzQocG9zLngsIHBvcy55LCAwLjUsIDEuMCk7Cn0KCg";
kha_Shaders.pass_vertData1 = "s128:I3ZlcnNpb24gMzAwIGVzCgppbiB2ZWMyIHBvczsKCnZvaWQgbWFpbigpCnsKICAgIGdsX1Bvc2l0aW9uID0gdmVjNChwb3MueCwgcG9zLnksIDAuNSwgMS4wKTsKfQoK";
kha_Shaders.pass_vertData2 = "s144:I3ZlcnNpb24gMTAwCgphdHRyaWJ1dGUgbWVkaXVtcCB2ZWMyIHBvczsKCnZvaWQgbWFpbigpCnsKICAgIGdsX1Bvc2l0aW9uID0gdmVjNChwb3MueCwgcG9zLnksIDAuNSwgMS4wKTsKfQoK";
