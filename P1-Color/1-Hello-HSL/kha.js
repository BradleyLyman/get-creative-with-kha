...
App.prototype = {
	...
	,onMouseMove: function(x,y,dx,dy) {
		var normX = x / kha_System.windowWidth(0);
		var normY = y / kha_System.windowHeight(0);
		var t = normX < 0 ? 0 : normX > 1 ? 1 : normX;
		this.columns = Math.round((1.0 - t) * 3 + t * 360);
		var t1 = normY < 0 ? 0 : normY > 1 ? 1 : normY;
		this.rows = Math.round((1.0 - t1) * 3 + t1 * 50);
	}
	,lerp: function(t,start,end) {
	...
	,render: function(framebuffers) {
		...
		var graphics = screen.get_g2();
		var trans__00 = screen.get_width() / this.X_RANGE;
		var trans__10 = 0;
		var trans__20 = 0;
		var trans__01 = 0;
		var trans__11 = screen.get_height() / this.Y_RANGE;
		var trans__21 = 0;
		var trans__02 = 0;
		var trans__12 = 0;
		var trans__22 = 1;
	...
	,draw: function(graphics) {
		var width = this.X_RANGE / this.columns;
		var height = this.Y_RANGE / this.rows;
		graphics.begin();
		var _g = 0;
		...
		while(_g < _g1) {
			...
			while(_g2 < _g11) {
				var row = _g2++;
				var normC = col / this.columns;
				var normR = row / this.rows;
				var nextR = (row + 1) / this.rows;
				var hsl = new support_HSL(normC * 360,0.7,(normR + nextR) / 2.0,null);
				graphics.set_color(hsl.toColor());
				graphics.fillRect(this.X_RANGE * normC,this.Y_RANGE * normR,width,height);
			}
		}
		graphics.end();
	}
...
var support_HSL = function(h,s,l,a) {
	if(a == null) {
		a = 1.0;
	}
	if(l == null) {
...
$hxClasses["support.HSL"] = support_HSL;
support_HSL.__name__ = true;
support_HSL.prototype = {
	h: null
	,s: null
	,l: null
	,a: null
	,toColor: function() {
		var C = this.s * (1.0 - Math.abs(2.0 * this.l - 1));
		var H = this.h / 60.0;
		var X = C * (1 - Math.abs(H % 2.0 - 1));
		var triple = H >= 0.0 && H < 1.0 ? { r : C, g : X, b : 0} : H >= 1.0 && H < 2.0 ? { r : X, g : C, b : 0} : H >= 2.0 && H < 3.0 ? { r : 0, g : C, b : X} : H >= 3.0 && H < 4.0 ? { r : 0, g : X, b : C} : H >= 4.0 && H < 5.0 ? { r : X, g : 0, b : C} : H >= 5.0 && H < 6.0 ? { r : C, g : 0, b : X} : { r : 0, g : 0, b : 0};
		var m = this.l - C / 2.0;
		return kha__$Color_Color_$Impl_$.fromFloats(triple.r + m,triple.g + m,triple.b + m,this.a);
	}
	,set_h: function(h) {
		if(h >= 0) {
			return this.h = h % 360;
	...
	,set_s: function(s) {
		return this.s = s < 0 ? 0 : s > 1 ? 1 : s;
	}
	,set_l: function(l) {
		return this.l = l < 0 ? 0 : l > 1 ? 1 : l;
	}
	,set_a: function(a) {
		return this.a = a < 0 ? 0 : a > 1 ? 1 : a;
	}
	,__class__: support_HSL
};
