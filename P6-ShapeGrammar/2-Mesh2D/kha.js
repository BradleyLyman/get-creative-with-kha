...
App.prototype = {
	...
	,render: function(framebuffers) {
		...
		var mesh = new Mesh2d();
		mesh.addLine(new Line(new kha_math_FastVector2(0,100),new kha_math_FastVector2(200,0)));
		mesh.addLine(new Line(new kha_math_FastVector2(10,10),new kha_math_FastVector2(100,100)));
		mesh.addLine(new Line(new kha_math_FastVector2(-25,-98),new kha_math_FastVector2(0,-4)));
		mesh.center();
		mesh.scaleToFit(new kha_math_FastVector2(screen.get_width() * 0.95,screen.get_height() * 0.95));
		g2.begin();
